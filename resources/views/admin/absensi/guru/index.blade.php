    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.absensi.guru.index') }}" method="GET" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('admin.absensi.guru.index') }}" class="btn btn-secondary">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.absensi.guru.detail', $guru->id) }}?filter={{ $filter }}&start_date={{ $startDate }}&end_date={{ $endDate }}"
