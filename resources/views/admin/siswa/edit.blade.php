                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select @error('tingkat') is-invalid @enderror" id="tingkat" name="tingkat" required>
                                        ...
                                        <option value="7" {{ old('tingkat', $student->studentProfile->kelas->tingkat ?? '') == '7' ? 'selected' : '' }}>Kelas 7</option>
                                        <option value="8" {{ old('tingkat', $student->studentProfile->kelas->tingkat ?? '') == '8' ? 'selected' : '' }}>Kelas 8</option>
                                        <option value="9" {{ old('tingkat', $student->studentProfile->kelas->tingkat ?? '') == '9' ? 'selected' : '' }}>Kelas 9</option>
                                    </select>
                                    @error('tingkat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="kelas"
                                           name="kelas"
                                           value="{{ old('kelas', $student->studentProfile->kelas->nama_kelas ?? '') }}"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text"
                                           ...
                                           id="tahun_angkatan"
                                           name="tahun_angkatan"
                                           value="{{ old('tahun_angkatan', $student->studentProfile->tahun_angkatan ?? date('Y')) }}"
                                           placeholder="{{ date('Y') }}"
                                           maxlength="4">
