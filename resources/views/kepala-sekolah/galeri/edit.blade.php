...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('kepala-sekolah.galeri.index') }}" class="btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('kepala-sekolah.galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
