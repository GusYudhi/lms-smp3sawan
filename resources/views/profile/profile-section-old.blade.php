...
<script>
        ...
        function updatePasswordButton() {
                ...
                <div class="card-body p-4">
                    <form id="profile-form" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            @if(auth()->user()->role === 'guru' || auth()->user()->role === 'kepala_sekolah')
                                <!-- Status Kepegawaian -->
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select id="status_kepegawaian"
                                            ...
                                            <option value="PNS" {{ old('status_kepegawaian', auth()->user()->status_kepegawaian) == 'PNS' ? 'selected' : '' }}>
                                                PNS
                                            </option>
                                            <option value="PPPK" {{ old('status_kepegawaian', auth()->user()->status_kepegawaian) == 'PPPK' ? 'selected' : '' }}>
                                                PPPK
                                            </option>
                                            <option value="Honorer" {{ old('status_kepegawaian', auth()->user()->status_kepegawaian) == 'Honorer' ? 'selected' : '' }}>
                                                Honorer
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('golongan', auth()->user()->golongan ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('wali_kelas', auth()->user()->wali_kelas ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                            @endif
            ...
            @php
                ...
                $hasAdditionalProfile = $profile !== null;
            @endphp

            @if($hasAdditionalProfile || auth()->user()->role === 'siswa')
            ...
            <div class="card card-stats border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <form id="additional-profile-form">
                        @csrf
                        <div class="row g-4">
                            @if(auth()->user()->role === 'siswa')
                                <!-- NIS -->
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="nis" class="form-label fw-medium text-high-contrast">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="nisn" class="form-label fw-medium text-high-contrast">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="kelas" class="form-label fw-medium text-high-contrast">
                                            Kelas
                                        </label>
                                            ...
                                            @for($i = 7; $i <= 9; $i++)
                                                @foreach(['A', 'B', 'C', 'D'] as $section)
                                                    <option value="{{ $i }}-{{ $section }}"
                                                            {{ old('kelas', $profile->kelas ?? '') == "$i-$section" ? 'selected' : '' }}>
                                                        {{ $i }}-{{ $section }}
                                                    </option>
                                                @endforeach
                                            @endfor
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tahun_masuk" class="form-label fw-medium text-high-contrast">
                                            Tahun Masuk
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="number"
                                                   ...
                                                   min="2010"
                                                   max="{{ date('Y') }}"
                                                   value="{{ old('tahun_masuk', $profile->tahun_masuk ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="nama_orangtua_wali" class="form-label fw-medium text-high-contrast">
                                            Nama Orang Tua/Wali
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('nama_orangtua_wali', $profile->nama_orangtua_wali ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="pekerjaan_orangtua" class="form-label fw-medium text-high-contrast">
                                            Pekerjaan Orang Tua
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('pekerjaan_orangtua', $profile->pekerjaan_orangtua ?? '') }}">
                                        </div>
                                    </div>
                                </div>

                            @elseif(auth()->user()->role === 'guru' || auth()->user()->role === 'kepala_sekolah')
                                <!-- NIP -->
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="pendidikan_terakhir" class="form-label fw-medium text-high-contrast">
                                            Pendidikan Terakhir
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tahun_mulai_mengajar" class="form-label fw-medium text-high-contrast">
                                            Tahun Mulai Mengajar
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="number"
                                                   ...
                                                   name="tahun_mulai_mengajar"
                                                   class="form-control"
                                                   placeholder="Contoh: 2015"
                                                   min="1990"
                                                   max="{{ date('Y') }}"
                                                   value="{{ old('tahun_mulai_mengajar', $profile->tahun_mulai_mengajar ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="sertifikat" class="form-label fw-medium text-high-contrast">
                                            Sertifikat
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="sertifikat"
                                                   class="form-control"
                                                   placeholder="Contoh: Sertifikat Pendidik"
                                                   value="{{ old('sertifikat', $profile->sertifikat ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-success btn-lg">
                                <i class="fas fa-save me-2"></i>Simpan Informasi Tambahan
                            </button>
                        </div>
                    </form>
                </div>
