                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-end">
                            <a href="{{ route('guru.rekap-absensi.siswa', ['filter' => request('filter'), 'start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-bottom">
                    ...
                    <small class="text-muted" id="summary-month-label">
                        @if($absensi->count() > 0)
                            Bulan: {{ \Carbon\Carbon::parse($absensi->first()->date)->locale('id')->isoFormat('MMMM Y') }}
                        @else
...
<script>
    ...
    function loadMonthlyCalendar(year, month) {
        ...
        fetch(`/guru/rekap-absensi-siswa/${userId}/monthly?year=${year}&month=${month + 1}`, {
            method: 'GET',
            headers: {
