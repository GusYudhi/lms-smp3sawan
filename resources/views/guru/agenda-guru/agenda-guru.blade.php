                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h1 class="h3 mb-2 text-high-contrast">
                                <i class="fas fa-calendar-alt text-primary me-2"></i>Agenda dan Jurnal Guru
                            </h1>
                            <p class="text-subtle mb-0 fw-medium">Kelola agenda mengajar dan jurnal pembelajaran Anda</p>
                        </div>
        ...
        <div class="col-12">
            <div class="card card-modern border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ route('guru.agenda') }}" id="filterForm">
...
<div class="modal fade" id="addAgendaModal" tabindex="-1" aria-labelledby="addAgendaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('guru.agenda.store') }}" method="POST">
                @csrf
...
<script>
    ...
    function editAgenda(id, tanggal, kelas, jamMulaiId, jamSelesaiId, materi, statusJurnal, keterangan) {
        ...
        document.getElementById('editAgendaForm').action = `/guru/agenda/${id}`;
    ...
    function deleteAgenda(id) {
        document.getElementById('deleteAgendaForm').action = `/guru/agenda/${id}`;
